...
public:
	...
	static v8::Handle<v8::Value> bridjs::Struct::GetField(const v8::Arguments& args);
	static v8::Handle<v8::Value> bridjs::Struct::SetField(const v8::Arguments& args);
	...
	static const size_t bridjs::Struct::getFieldsSize(const std::vector<const char> &fieldTypes, const size_t alignment=DEFAULT_ALIGNMENT);
